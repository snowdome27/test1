...
------------------------------------------------ */
	...
	public ArrayList<PurchaseHistoryDTO> sortPriceDesc(String userId) throws SQLException{
		...
		String sql = "SELECT phi.id, pi.product_id, pi.product_name, pi.product_name_kana, pi.image_file_path,  phi.price, phi.product_count, pi.release_company, pi.release_date, phi.insert_date  "
	...
	public ArrayList<PurchaseHistoryDTO> sortPriceAsc(String userId) throws SQLException{
		...
		String sql = "SELECT phi.id, pi.product_id, pi.product_name, pi.product_name_kana, pi.image_file_path,  phi.price, phi.product_count, pi.release_company, pi.release_date, phi.insert_date  FROM purchase_history_info as phi LEFT JOIN product_info as pi ON phi.product_id = pi.product_id  WHERE phi.user_id = ? ORDER BY price ASC";
